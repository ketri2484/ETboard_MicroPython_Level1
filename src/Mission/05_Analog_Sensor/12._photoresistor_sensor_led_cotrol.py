# ******************************************************************************************
# FileName     : 02._photoresistor_sensoer_led_cotrol
# Description  : 조도 센서 값이 1000보다 작으면 빨강 LED 켜 보기
# Author       : 오경석
...
# setup
def setup():
    sensor.atten(ADC.ATTN_11DB)            # 조도 센서을 입력 모드로 설정
...
def loop():
    ...
    print(sensor_result)                   # 쉘에 조도 센서 값 출력

    if sensor_result < 1000:               # 조도 센서의 값이 1000보다 작으면
